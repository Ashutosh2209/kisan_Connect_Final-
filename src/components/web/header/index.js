                        ...
                        <Grid item md={12} lg={11} xl={10} className="header_fixed">
                            <Grid container>
                                <Grid item md={3} lg={2} xl={2}>
                                    <div className="logo">
                                        <h1><Link to="#"><b>T <br />H <br />E </b>Kisan Connect<span> The Best choice</span></Link></h1>
                                    </div>
                                </Grid>
                                    ...
                                    <div className="collapse navbar-collapse" id="bs-megadropdown-tabs">
                                        <ul className="nav navbar-nav ">
                                            ...
                                            <li className="dropdown ">
                                                <Link to="/kitchen" className="dropdown-toggle  hyper"><span>Vegetables<b className="caret" /></span></Link>
                                                <ul className="dropdown-menu multi">
                                                    <div className="row">
                                                        <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Tomato</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Palak</Link></li>
                                                                <li><Link to="/kitchen"> <i className="fa fa-angle-right" aria-hidden="true" />Potato</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Onion</Link></li>
                                                            </ul>
                                                        </div>
                                                        <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Ginger</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Gobi</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Methi</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Baingan</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Beans</Link></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                            ...
                                            <li className="dropdown ">
                                                <Link to="/kitchen" className="dropdown-toggle  hyper"><span>Fruits<b className="caret" /></span></Link>
                                                <ul className="dropdown-menu multi">
                                                    <div className="row">
                                                        <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Mango</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Orange</Link></li>
                                                                <li><Link to="/kitchen"> <i className="fa fa-angle-right" aria-hidden="true" />Pomegranates</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Guava</Link></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                            ...
                                            <li className="dropdown ">
                                                <Link to="/kitchen" className="dropdown-toggle  hyper"><span>Dairy Products<b className="caret" /></span></Link>
                                                <ul className="dropdown-menu multi">
                                                    <div className="row">
                                                        <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Milk</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Dahi</Link></li>
                                                                <li><Link to="/kitchen"> <i className="fa fa-angle-right" aria-hidden="true" />Shrikhand</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Amrakhand</Link></li>
                                                            </ul>
                                                        </div>
                                                        <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Ghee</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Ice-Cream</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Khoa</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Paneer</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Butter</Link></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                            ...
                                            <li className="dropdown">
                                                <Link to="#" className="dropdown-toggle hyper" data-toggle="dropdown"><span> Other <b className="caret" /></span></Link>
                                                <ul className="dropdown-menu multi multi1">
                                                    <div className="row">
                                                        <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                                                <li><Link to="/care"><i className="fa fa-angle-right" aria-hidden="true" /> Turmeric Powder </Link></li>
                                                                <li><Link to="/care"><i className="fa fa-angle-right" aria-hidden="true" />Tomato Ketchup</Link></li>
                                                                <li><Link to="/care"><i className="fa fa-angle-right" aria-hidden="true" />Amla Candy</Link></li>
                                                                <li><Link to="/care"><i className="fa fa-angle-right" aria-hidden="true" />Chips</Link></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                            ...
                                            {/* <li className="dropdown">
                                                <Link to="#" className="dropdown-toggle hyper" data-toggle="dropdown"><span><b className="caret" /></span></Link>
                                                <ul className="dropdown-menu multi multi2">
                                                    <div className="row"> */}
                                                        ...
                                                        {/* <div className="col-sm-3 w3l">
                                                            <Link to="/house-hold"><img src="images/me1.png" className="img-responsive" alt="" /></Link>
                                                        </div>
                                                        <div className="clearfix" />
                                                    </div> */}
                                                {/* </ul> */}
