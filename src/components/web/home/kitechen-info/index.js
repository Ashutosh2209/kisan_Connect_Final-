                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="/" data-toggle="modal" data-target="#myModal1" className="offer-img">
                                    <img src="/images/big-3.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Oranges</Link>(1 kg)</h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>Rs.80</label><em className="item_price">Rs.40</em></p>
                                        <div className="block">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal2" className="offer-img">
                                    <img src="images/img-13.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Onion</Link>(1 kg)</h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>Rs.100</label><em className="item_price">Rs.60</em></p>
                                        <div className="block">
                                            <div className="starbox small ghosting"> </div>
                                        </div>
                                        <div className="clearfix" />
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal3" className="offer-img">
                                    <img src="images/img-1.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Gobi</Link>(1 kg)</h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>Rs.40</label><em className="item_price">Rs.20</em></p>
                                        <div className="block">
                                            <div className="starbox small ghosting"> </div>
                                        </div>
                                        <div className="clearfix" />
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal4" className="offer-img">
                                    <img src="images/img-10.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Paneer</Link>(200 g)</h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>Rs.100</label><em className="item_price">Rs.80</em></p>
                                        <div className="block">
                                            <div className="starbox small ghosting"> </div>
                                        </div>
                                        <div className="clearfix" />
                        ...
                        <div className=" con-w3l">
                            ...
                            <div className="col-md-3 pro-1">
                                <div className="col-m">
                                    ...
                                    <div className="mid-1">
                                        ...
                                        <div className="mid-2">
                                            <p><label>Rs.30</label><em className="item_price">Rs.10</em></p>
                                            <div className="block">
                                                <div className="starbox small ghosting"> </div>
                                            </div>
                                            <div className="clearfix" />
                            ...
                            <div className="col-md-3 pro-1">
                                <div className="col-m">
                                    ...
                                    <div className="mid-1">
                                        <div className="women">
                                            <h6><Link to="/product-details"> Onion</Link>(500 g)</h6>
                                        </div>
                                        <div className="mid-2">
                                            <p><label>Rs.30</label><em className="item_price">Rs.20</em></p>
                                            <div className="block">
                                                <div className="starbox small ghosting"> </div>
                                            </div>
                                            <div className="clearfix" />
                            ...
                            <div className="col-md-3 pro-1">
                                <div className="col-m">
                                    ...
                                    <div className="mid-1">
                                        ...
                                        <div className="mid-2">
                                            <p><label>Rs.80</label><em className="item_price">Rs.60</em></p>
                                            <div className="block">
                                                <div className="starbox small ghosting"> </div>
                                            </div>
                                            <div className="clearfix" />
                            ...
                            <div className="col-md-3 pro-1">
                                <div className="col-m">
                                    ...
                                    <div className="mid-1">
                                        <div className="women">
                                            <h6><Link to="/product-details">Gobi</Link>(250 g)</h6>
                                        </div>
                                        <div className="mid-2">
                                            <p><label>Rs.20</label><em className="item_price">Rs.10</em></p>
                                            <div className="block">
                                                <div className="starbox small ghosting"> </div>
                                            </div>
                                            <div className="clearfix" />
                            ...
                            <div className="col-md-3 pro-1">
                                <div className="col-m">
                                    <Link to="#" data-toggle="modal" data-target="#myModal22" className="offer-img">
                                        <img src="images/img-4.jpg" className="img-responsive" alt="" />
                                    </Link>
                                    <div className="mid-1">
                                        <div className="women">
                                            <h6><Link to="/product-details">Carrot</Link>(500 g)</h6>
                                        </div>
                                        <div className="mid-2">
                                            <p><label>Rs.40</label><em className="item_price">Rs.20</em></p>
                                            <div className="block">
                            ...
                            <div className="col-md-3 pro-1">
                                <div className="col-m">
                                    <Link to="#" data-toggle="modal" data-target="#myModal23" className="offer-img">
                                        <img src="images/img-14.jpg" className="img-responsive" alt="" />
                                    </Link>
                                    <div className="mid-1">
                                        <div className="women">
                                            <h6><Link to="/product-details">Capsicum</Link>(250 kg)</h6>
                                        </div>
                                        <div className="mid-2">
                                            <p><label>Rs.20</label><em className="item_price">Rs.15</em></p>
                                            <div className="block">
                                                <div className="starbox small ghosting"> </div>
                                            </div>
                                            <div className="clearfix" />
                            ...
                            <div className="col-md-3 pro-1">
                                <div className="col-m">
                                    <Link to="#" data-toggle="modal" data-target="#myModal24" className="offer-img">
                                        <img src="images/img-5.jpg" className="img-responsive" alt="" />
                                    </Link>
                                    <div className="mid-1">
                                        <div className="women">
                                            <h6><Link to="/product-details">Banana</Link>(1 dozon)</h6>
                                        </div>
                                        <div className="mid-2">
                                            <p><label>Rs.50</label><em className="item_price">Rs.30</em></p>
                                            <div className="block">
                                                <div className="starbox small ghosting"> </div>
                                            </div>
                                            <div className="clearfix" />
