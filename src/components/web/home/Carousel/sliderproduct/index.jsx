                    ...
                    <Slider {...settingsMobile}>
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Pomegranates</Link>(1 kg)</h6>
                                    </div>
                                    <div className="mid-2">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Banana</Link>(5 kg)</h6>
                                    </div>
                                    <div className="mid-2">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Kabuli</Link>(1 kg)</h6>
                                    </div>
                                    <div className="mid-2">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Soya</Link>(1 kg)</h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>$4.00</label><em className="item_price">$3.50</em></p>
                                        <div className="block">
                ...
                <div>
                    <Slider {...settings}>
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="/" data-toggle="modal" data-target="#myModal1" className="offer-img">
                                    <img src="/images/m.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Milk</Link>(1 L)</h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>Rs.50</label><em className="item_price">Rs.40</em></p>
                                        <div className="block">
                                            <div className="starbox small ghosting"> </div>
                                        </div>
                                        <div className="clearfix" />
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal2" className="offer-img">
                                    <img src="images/da.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Dahi</Link>(5 kg)</h6>
                                    </div>
                                    <div className="mid-2">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal4" className="offer-img">
                                    <img src="images/am.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Amrakhand</Link>(500 g)</h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>Rs.100</label><em className="item_price">Rs.90</em></p>
                                        <div className="block">
                                            <div className="starbox small ghosting"> </div>
                                        </div>
                                        <div className="clearfix" />
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Shrikhand</Link>(500 g)</h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>Rs.110</label><em className="item_price">Rs.100</em></p>
                                        <div className="block">
                                            <div className="starbox small ghosting"> </div>
                                        </div>
                                        <div className="clearfix" />
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal4" className="offer-img">
                                    <img src="images/kh.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Khoa</Link>(250 g)</h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>Rs.120</label><em className="item_price">Rs.100</em></p>
                                        <div className="block">
                                            <div className="starbox small ghosting"> </div>
                                        </div>
                                        <div className="clearfix" />
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal4" className="offer-img">
                                    <img src="images/ghee.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Ghee</Link>(250 g)</h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>Rs.350</label><em className="item_price">Rs.300</em></p>
                                        <div className="block">
                                            <div className="starbox small ghosting"> </div>
                                        </div>
                                        <div className="clearfix" />
